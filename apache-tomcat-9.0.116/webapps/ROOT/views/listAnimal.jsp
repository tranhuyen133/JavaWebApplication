...
<body>
<div class="container">
  <h1 class="title">Thêm thú cưng</h1>

  <%-- form gửi dữ liệu bằng POST lên /animals/add --%>
  <form action="${pageContext.request.contextPath}/animals/add" method="post">
